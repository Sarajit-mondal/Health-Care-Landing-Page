...
function Misstion() {
  return (
    <div className='my-40 flex flex-col md:flex-row gap-10 md:gap-32'>
        {/* left */}
        ...
        <div className='md:relative md:w-[568px] w-full'>
            <img src={missition} alt="" className='md:absolute w-full h-full'/>
            {/* card */}
            <div className='md:absolute z-10 bg-[#343268] -bottom-10 -left-20 md:w-96 text-left px-5 space-y-2 py-7 text-white rounded-3xl'>
